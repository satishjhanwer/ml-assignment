...
![Confusion Matrix - Scratch](image-2.png)

### Confusion Matrix - Sklearn Implementation

![Confusion Matrix - Sklearn](image-3.png)

### Overall Result

![Classification Comparison Report](image-5.png)

## Accuracy & Time Comparison

- **Accuracy for Naive Bayes from Scratch**: `0.873239`
- **Time for Naive Bayes from Scratch**: `0.002260 seconds`

- **Accuracy for Sklearn Naive Bayes**: `0.887324`
